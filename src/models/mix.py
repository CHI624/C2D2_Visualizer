...
def mix_util(states):
    return 3 * states['Ribbon Bridge Status'] - 1 * states['Weather Status'] - 2 * states['Enemy Fires'] + 2 * states['Fire Across Gap']
...
model = CDN(nodes=['Ribbon Bridge Status', 'Weather Status', 'Ammo Supply', 'Fire Across Gap', 'Enemy Presence', 'Enemy Fires', 'Enemy ATK/Artillery'],
            ...
            util_func=mix_util,
            util_nodes=['Ribbon Bridge Status', 'Weather Status', 'Enemy Fires', 'Fire Across Gap'])
